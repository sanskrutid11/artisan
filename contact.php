            ...
            <div class="container py-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="" class="">
                                <input type="text" class="w-100 form-control border-0 py-3 mb-4" id=
                                "name" name="name" placeholder="Your Name">
                                <input type="email" id="email" class="w-100 form-control border-0 py-3 mb-4" name="email" placeholder="Enter Your Email">
                                <textarea class="w-100 form-control border-0 mb-4" rows="5" cols="10" placeholder="Your Message" id="message" name="message"></textarea>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">Rahuri,Maharashtra</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">artisian@gmail.com</p>
                                </div>
                            </div>
